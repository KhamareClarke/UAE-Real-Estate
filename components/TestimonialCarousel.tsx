      ...
      <div className="flex flex-col items-center justify-center gap-3 mb-2">
        ...
        <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-full overflow-hidden flex-shrink-0">
          <Image
            ...
            alt={`${currentTestimonial.author} - UAE real estate investor testimonial`}
            width={56}
            height={56}
            quality={95}
        ...
        <div className="text-center">
          <div className="flex items-center justify-center gap-1.5 sm:gap-2 mb-1">
            <p className="text-base sm:text-lg md:text-xl font-bold text-navy-900 tracking-tight">{currentTestimonial.author}</p>
            {/* Country Flag Icon */}
