        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mt-20 bg-gradient-to-r from-navy to-navy-900 rounded-3xl p-12 text-center shadow-2xl">
            ...
            <div className="space-y-2">
              <button className="bg-gradient-to-r from-accent to-accent-light hover:from-accent-dark hover:to-accent text-white font-bold px-12 py-5 rounded-xl transition-all duration-300 shadow-xl hover:shadow-2xl hover:scale-105 inline-flex items-center gap-3">
