      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-12">
        <div className="max-w-7xl mx-auto">
                    ...
                    <div className="group relative overflow-hidden rounded-2xl shadow-2xl bg-white">
                      ...
                      <div className="p-8 space-y-4">
                        ...
                        <div className="pt-16 space-y-4">
                          ...
                          <button className="w-full bg-[#FF6A00] hover:bg-[#FF8534] text-white font-bold py-4 px-6 rounded-xl transition-all shadow-lg hover:shadow-xl hover:scale-105 min-h-[44px] text-base sm:text-base">
              ...
              >
                ...
                <div className="p-8 space-y-4">
                  ...
                  <div className="pt-16 space-y-4">
                    ...
                    <button className="w-full bg-[#FF6A00] hover:bg-[#FF8534] text-white font-bold py-4 px-6 rounded-xl transition-all shadow-lg hover:shadow-xl hover:scale-105 group-hover:shadow-[#FF6A00]/30 min-h-[44px] text-base sm:text-base">
                      Request Investment Breakdown
                    </button>
                  </div>
                </div>
          ...
          <div className="text-center mt-16 space-y-3">
            <a href="#quick-form">
              <button className="bg-[#FF6A00] hover:bg-[#FF8534] text-white font-bold px-6 sm:px-8 md:px-12 py-4 sm:py-5 rounded-xl transition-all duration-300 shadow-xl shadow-[#FF6A00]/30 hover:shadow-2xl hover:scale-105 inline-flex items-center gap-3 min-h-[44px] text-base sm:text-lg w-full sm:w-auto justify-center">
