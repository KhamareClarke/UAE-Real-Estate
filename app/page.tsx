...
export const metadata = {
  title: 'Private Access to Prime UAE Real Estate | City Plaza Real Estate',
  description: 'Developer-direct residences. Golden Visa eligible. Structured payment plans. RERA-licensed advisors. Private investment review available.',
};
    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="py-16 bg-gradient-to-b from-white via-gray-50 to-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 max-w-6xl relative z-10">
          <h2 className="text-3xl xs:text-4xl sm:text-5xl md:text-6xl font-black text-center mb-8 sm:mb-12 tracking-tight">
          ...
          <div className="text-center mt-12 space-y-2">
            <a href="#elite-form">
              <button className="btn-primary text-lg px-12 py-5 rounded-2xl">
      ...
      <section className="py-16 bg-gradient-to-b from-white to-gray-50 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 max-w-3xl text-center relative z-10">
          ...
          <div className="space-y-3">
            <a href="#elite-form">
              <button className="btn-primary text-base sm:text-lg md:text-xl px-6 sm:px-12 md:px-20 py-5 sm:py-6 md:py-7 rounded-2xl min-h-[44px] w-full sm:w-auto">
        ...
        <div className="container mx-auto px-4 sm:px-6 max-w-6xl relative z-10">
          ...
          <div className="border-t border-white/10 pt-8 sm:pt-10 md:pt-12 mb-8 sm:mb-10 md:mb-12 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-x-4 sm:gap-x-6 md:gap-x-8 gap-y-3 mb-4 sm:mb-6">
              ...
              <a href="/terms" className="text-white/70 hover:text-primary-400 transition-colors text-[10px] sm:text-xs font-medium hover:underline underline-offset-4 break-words">Disclaimer</a>
              <a href="/privacy" className="text-white/70 hover:text-primary-400 transition-colors text-[10px] sm:text-xs font-medium hover:underline underline-offset-4 break-words">Cookie Policy</a>
            </div>
